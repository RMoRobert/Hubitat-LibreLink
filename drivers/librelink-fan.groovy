...
metadata {
   definition (name: "LibreLink Fan", namespace: "RMoRobert", author: "Robert Morris", importUrl: "https://raw.githubusercontent.com/RMoRobert/Hubitat-LibreLink/main/drivers/librelink-fan.groovy") {
      capability "Actuator"
      capability "Refresh"
      capability "Switch"
...
// reasons; probably should use "Fan with Switch Level" driver instead:
