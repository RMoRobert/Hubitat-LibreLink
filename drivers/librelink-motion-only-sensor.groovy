...
metadata {
   definition (name: "LibreLink Motion (No Temp) Sensor", namespace: "RMoRobert", author: "Robert Morris", importUrl: "https://raw.githubusercontent.com/RMoRobert/Hubitat-LibreLink/main/drivers/librelink-motion-only-sensor.groovy") {
      capability "Sensor"
      capability "MotionSensor"
      // Can comment out if don't want battery capability either:
      capability "Battery"
      capability "Refresh"
