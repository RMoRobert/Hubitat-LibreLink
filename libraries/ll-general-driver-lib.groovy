...
library (
  ...
  description: "LibreLink general driver methods (installed, updated, initialize, debugOn, debugOff, doSendEvent)",
  name: "LibreLink-Driver-General",
  namespace: "RMoRobert"
)
...
/* ======== Custom command included in all LibreLink drivers: ======== */
